  ...
  render() {
    return (
      <Router history={history}>
        <Switch>
          <Route exact path="/admin/" render={() => <Redirect to={window.app.defaultPath} />} />
          {
...
class App extends React.Component {
      ...
      <div className={window.app.user.id ? "" : "unauthenticated"}>
        ...
        <div className={(this.state.shownMenu ? "nav--fixed " : "") + "nav"}>
          <div className="nav__header">
            ...
            <div className="logo">{this.state.app.name}</div>
          ...
          <div className="menu">
            <Menu theme="dark" mode="vertical" onSelect={this.onSelect}
              ...
              <Menu.SubMenu index="user" key="user" className="submenu-fixed"
                title={
                  <span>
                    <div className="menu-user__image" onClick={() => this.onSelect("/admin/user/profile")}>
              ...
              </Menu.SubMenu>
              {
                window.app.menus.map((menu, i) => {
                  ...
                  if (this.hasRoles(menu.rolesAllowed) && menu.enabled) {
                    if (menu.children) {
                      return (
  ...
  onSelect(index) {
    if (index.startsWith("/")) {
      ...
      window.ajax("/admin/api/switch-language/" + index, { method: "GET" })
        .then(function() {
