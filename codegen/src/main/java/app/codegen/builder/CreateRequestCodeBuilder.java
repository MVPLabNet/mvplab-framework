 ...
 * @author chi
 */
public class CreateRequestCodeBuilder extends AbstractCodeBuilder {
    public CreateRequestCodeBuilder(EntityModel entityModel, VelocityEngine templateEngine) {
        super(entityModel, "codegen/java/web/api/entity/create-request.vm", templateEngine);
    }
    ...
    public Path path() {
        EntityModel entityModel = entityModel();
        return entityModel.basePath.resolve("web/api/" + entityModel.shortName + "/Create" + entityModel.type + "Request.java");
    }
}
