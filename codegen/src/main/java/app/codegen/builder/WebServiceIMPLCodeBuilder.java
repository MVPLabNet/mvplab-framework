 ...
 * @author chi
 */
public class WebServiceIMPLCodeBuilder extends AbstractCodeBuilder {
    public WebServiceIMPLCodeBuilder(EntityModel entityModel, VelocityEngine templateEngine) {
        super(entityModel, "codegen/java/web/webservice-impl.vm", templateEngine);
    }
    ...
    public String build() {
        ...
        context.put("packageName", entityModel.basePackage + ".web");
    ...
    public Path path() {
        EntityModel entityModel = entityModel();
        return entityModel.basePath.resolve("web/" + entityModel.type + "WebServiceImpl.java");
    }
}
