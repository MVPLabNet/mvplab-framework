 ...
 * @author chi
 */
public class QueryCodeBuilder extends AbstractCodeBuilder {
    public QueryCodeBuilder(EntityModel entityModel, VelocityEngine templateEngine) {
        super(entityModel, "codegen/java/web/api/entity/query.vm", templateEngine);
    }
    ...
    public Path path() {
        EntityModel entityModel = entityModel();
        return entityModel.basePath.resolve("web/api/" + entityModel.shortName + "/" + entityModel.type + "Query.java");
    }
}
