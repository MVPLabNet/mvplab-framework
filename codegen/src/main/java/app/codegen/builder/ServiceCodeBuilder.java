...
public class ServiceCodeBuilder extends AbstractCodeBuilder {
    public ServiceCodeBuilder(EntityModel entityModel, VelocityEngine templateEngine) {
        super(entityModel, "codegen/java/service/service.vm", templateEngine);
    }
    ...
    public String build() {
        ...
        context.put("packageName", entityModel.basePackage + ".service");
    ...
    public Path path() {
        EntityModel entityModel = entityModel();
        return entityModel.basePath.resolve("service/" + entityModel.type + "Service.java");
    }
}
