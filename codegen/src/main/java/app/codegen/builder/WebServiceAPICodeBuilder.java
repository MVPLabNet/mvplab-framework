 ...
 * @author chi
 */
public class WebServiceAPICodeBuilder extends AbstractCodeBuilder {
    public WebServiceAPICodeBuilder(EntityModel entityModel, VelocityEngine templateEngine) {
        super(entityModel, "codegen/java/web/api/webservice-api.vm", templateEngine);
    }
    ...
    public String build() {
        ...
        context.put("packageName", entityModel.basePackage + ".web.api");
    ...
    public Path path() {
        EntityModel entityModel = entityModel();
        return entityModel.basePath.resolve("web/api/" + entityModel.type + "WebService.java");
    }
}
