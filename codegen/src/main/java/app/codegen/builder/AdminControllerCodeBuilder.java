 ...
 * @author chi
 */
public class AdminControllerCodeBuilder extends AbstractCodeBuilder {
    public AdminControllerCodeBuilder(EntityModel entityModel, VelocityEngine templateEngine) {
        super(entityModel, "codegen/java/web/admin/admin-controller.vm", templateEngine);
    }
    ...
    public String build() {
        ...
        context.put("packageName", entityModel.basePackage + ".web.admin");
    ...
    public Path path() {
        EntityModel entityModel = entityModel();
        return entityModel.basePath.resolve("web/admin/" + entityModel.type + "AdminController.java");
    }
}
