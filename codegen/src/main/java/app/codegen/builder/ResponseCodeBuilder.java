 ...
 * @author chi
 */
public class ResponseCodeBuilder extends AbstractCodeBuilder {
    public ResponseCodeBuilder(EntityModel entityModel, VelocityEngine templateEngine) {
        super(entityModel, "codegen/java/web/api/entity/response.vm", templateEngine);
    }
    ...
    public Path path() {
        EntityModel entityModel = entityModel();
        return entityModel.basePath.resolve("web/api/" + entityModel.shortName + "/" + entityModel.type + "Response.java");
    }
}
