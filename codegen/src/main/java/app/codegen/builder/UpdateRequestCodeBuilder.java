 ...
 * @author chi
 */
public class UpdateRequestCodeBuilder extends AbstractCodeBuilder {
    public UpdateRequestCodeBuilder(EntityModel entityModel, VelocityEngine templateEngine) {
        super(entityModel, "codegen/java/web/api/entity/update-request.vm", templateEngine);
    }
    ...
    public Path path() {
        EntityModel entityModel = entityModel();
        return entityModel.basePath.resolve("web/api/" + entityModel.shortName + "/Update" + entityModel.type + "Request.java");
    }
}
